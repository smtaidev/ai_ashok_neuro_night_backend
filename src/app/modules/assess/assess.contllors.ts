...
const result=await AssessServices.createtrendIntoDb(company.companyName,req.body)
 ...
 const updateTrendIntDb=catchAsync(async(req,res)=>{
    const company=req.user 
  const {id}=req.params
const result=await AssessServices.updateTrendInDb(company.companyName,id,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
    message: "trend  successfully updated !",
...
const result=await AssessServices.createSwotIntoDb(company.companyName,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
 ...
 const updateSwotIntDb=catchAsync(async(req,res)=>{
    const company=req.user 
  const {id}=req.params
const result=await AssessServices.updateSwotInDb(company.companyName,id,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
...
const result=await AssessServices.createChallengeIntoDb(company.companyName,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
 ...
 const updatChallengeIntDb=catchAsync(async(req,res)=>{
    const company=req.user 
  const {id}=req.params
const result=await AssessServices.updateChallengeInDb(company.companyName,id,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
    message: "challenge successfully updated !",
...
const result=await AssessServices.createCompetitorAnalysisIntoDb(company.companyName,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
...
const result=await AssessServices.createClarhetRecommendationIntoDb(company.companyName,req.body)
 sendResponse(res, {
    statusCode: 200,
    success: true,
