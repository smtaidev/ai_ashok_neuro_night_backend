...
const getTrendAirecommendations = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.getAllTrendsAiData(
    company?.companyName
  );
...
const getSwotirecommendations = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.getAllSowtAiData(
    company?.companyName
  );
...
const challengeRixScore = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.getChallengeRixScoreData(
    company?.companyName
  );
...
const challengerecommendations = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.getChallengetAiData(
    company?.companyName
  );
...
const createThemesAi = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.createThemesAiData(
    company?.companyName
  );
...
const createBusinessGoalAi = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.createBusinessGoalAi(
    company?.companyName
  );
...
const createSwotAiData = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.createSwotAiData(
    company?.companyName
  );
...
const getDifferentCapability = catchAsync(async (req, res) => {
  ...
  const result = await aiRespnonseServices.getDifferentCapability(
    company?.companyName
  );
...
const getThemesAiData = catchAsync(async (req, res) => {
  const company = req.user;
 console.log(company.companyName)
  const result = await aiRespnonseServices.getThemesAiData(
    company?.companyName
  );
  ...
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: "get themes data ai data  successfully get",
    data: result,
  });
});
